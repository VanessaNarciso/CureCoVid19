...
class DirFunc:
    ...
    def __init__(self):
        self.directorio_funciones = {
            'global': {'nombre': 'global', 'tipo': 'void', 'cantParametros': 0, 'variables': TablaVars(),
                       'cantQuads': 0}}
    ...
    def func_isVarDimensionada(self, nombre, nombreVar):
        if self.directorio_funciones[nombre]['variables'].var_exist(nombreVar):
            ...
            if self.directorio_funciones[nombre]['variables'].tabla_variables[nombreVar]['columnas'] > 0 or \
                    self.directorio_funciones[nombre]['variables'].tabla_variables[nombreVar]['renglones'] > 0:
                return 1
            else:
                return 0
        else:
    ...
    def func_getDims(self, nombre, nombreVar):
        if self.directorio_funciones[nombre]['variables'].var_exist(nombreVar):
            dim = [self.directorio_funciones[nombre]['variables'].tabla_variables[nombreVar]['columnas'],
    ...
    def listaTipos(self, funcion):
        return [self.directorio_funciones[funcion]['variables'].tabla_variables[x]['tipo'] for x in
                self.directorio_funciones[funcion]['variables'].tabla_variables]
